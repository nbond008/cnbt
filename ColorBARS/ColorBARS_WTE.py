...
def getdir():
    try:
        ...
        print('Tell Connor an error occurred in the getdir function.')
...
def detect_species():
    try:
        ...
        print('Tell Connor an error occurred in the detect_species function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def manage_species():
    try:
        ...
        print('Tell Connor an error occurred in the manage_species function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def preset_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the preset_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def choose_color(root_specmgr):
    try:
        ...
        print('Tell Connor an error occurred in the choose_color function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def close_customize(root_customize):
    try:
        ...
        print('Tell Connor an error occurred in the close_customize function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def set_all_vis():
    try:
        ...
        print('Tell Connor an error occurred in the set_all_vis function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def set_none_vis():
    try:
        ...
        print('Tell Connor an error occurred in the set_none_vis function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def close_specmgr(root_specmgr):
    try:
        ...
        print('Tell Connor an error occurred in the close_specmgr function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def get_box_color():
    try:
        ...
        print('Tell Connor an error occurred in the get_box_color function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def dots_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the dots_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def vol_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the vol_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def dotsize_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the dotsize_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def linewidth_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the linewidth_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def ballsize_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the ballsize_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def stickradius_select(event):
    try:
        ...
        print('Tell Connor an error occurred in the stickradius_select function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def toggler1():
    try:
        ...
        print('Tell Connor an error occurred in the toggler1 function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def toggler2():
    try:
        ...
        print('Tell Connor an error occurred in the toggler2 function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def apply_styles():
    ...
    ##        ColorBARS_assemble.mtd_reader(generalsettings_list, boxsettings_list, fieldsettings_list, mmolsettings_list)
        ...
        print('Tell Connor an error occurred in the apply_styles function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def manage_defaults():
    try:
        ...
        print('Tell Connor an error occurred in the manage_defaults function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def program_help():
    try:
        ...
        print('Tell Connor an error occurred in the program_help function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
def about_me():
    try:
        ...
        print('Tell Connor an error occurred in about_me toggler1 function.')
        print('Please include all the exact steps you did to get this error.')
        print('If you can include steps to reliably reproduce it, that would be great.')
...
try:
    ...
    print('Tell Connor an error occurred in the mainloop function.')
    print('Please include all the exact steps you did to get this error.')
    print('If you can include steps to reliably reproduce it, that would be great.')
